...
namespace Dafda.Consuming
{
    internal sealed class MessageHandlerRegistry
    {
        ...
        public MessageRegistration GetRegistrationFor(string topicName, string messageType)
        {
            return _registrations.SingleOrDefault(x => x.Topic == topicName &&  x.MessageType == messageType);
        }
    }
}